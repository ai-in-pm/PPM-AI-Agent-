...
export const DEFAULT_GUIDELINES: GuidelineAttributeMapping[] = [
  {
...
export function calculateConfidence(factors: ConfidenceFactors): number {
  ...
  return (
    factors.evidenceDensity * weights.evidenceDensity +
...
export function determineScoreLevel(score: number): string {
